...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Employee", "In order to add, edit, delete employee records\r\nAs an admin\r\nI want to modify emp" +
                    "loyee details in dashboard", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.TestCaseAttribute("Kalyani", "Ashish", "Vidhate", "101", "on", "kalyani123", "kalyani@123", "kalyani@123", "disabled", null)]
        [NUnit.Framework.TestCaseAttribute("Shrushti", "Ashish2", "Patil", "102", "on", "shrushti124", "shrushti@123", "shrushti@123", "disabled", null)]
        public virtual void AddValidEmployee(string firstname, string middlename, string lastname, string empid, string toggle_Login_Detail, string username, string password, string confirmpassword, string status, string[] exampleTags)
        {
